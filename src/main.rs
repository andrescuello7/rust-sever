// IMPORTA EXTENCIONES DE CARGO.TOML
use actix_cors::Cors;
...
// REFERENCIA A MODULOS EXTERNOS
mod api_router;
mod api_service;

// CONTRUYE EL SERVICIOS DE API
pub struct ServiceManager {
    api: ApiService,
}

// IMPLEMENTCAION DE API_SERVICES
impl ServiceManager {
...
// CONTRUYE EL SERVICIOS DE MANAGER
pub struct AppState {
